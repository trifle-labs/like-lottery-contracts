...
contract LikeLotteryV3 is Ownable {
    bytes32 public nonce;
    address public admin = 0xF0f5562325BFf40d4C051437Df406415ca89E94a;
    uint256 public yankLoopCount = 1;
    uint256 public yankCost = 0 ether;
    ...
    event Yank(address indexed drawnBy, bytes32 random, uint256 indexed drawId);
     ...
     */
    function _yank(address yanker, uint256 drawId) internal {
     ...
     */
    function adminYank(address yanker, uint256 drawId) public {
        require(
    ...
    function setYankCost(uint256 _yankCost) public onlyOwner {
        yankCost = _yankCost;
    }
